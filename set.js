...
global.botToken = '7469326338:AAHKKhYCjZ4OysF_CXCV61fJs4wz556njoM'; // Replace With Your Bot Token (Get it from BotFather)
global.ownerUsername = 'Pease Ernest'; // Replace With Your Telegram Username(For Bot Owner)
global.timeZone = 'Africa/Nairobi'; // Your Time Zone
global.ownerId = [7065689166]; // Replace With Your Owner ID(For Bot Owner), You Can Add More than 1
global.footer = '*Powered by Ernest Pease*';
